  ...
  return (
    <div className="mt-8">
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        aria-expanded={open}
        className="group flex w-full cursor-pointer items-center justify-between gap-4 border-y border-[var(--color-border)] py-4 t-body text-[var(--color-ink)] transition-colors hover:text-[var(--color-ink-2)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-focus)]"
      >
          ...
          >
            {banks.map((b) => (
              <RA.Item key={b.value} value={b.value}>
                <RA.Header>
                  <RA.Trigger className="group flex w-full cursor-pointer items-center justify-between gap-3 py-3.5 text-left t-body text-[var(--color-ink)] transition-colors hover:text-[var(--color-ink-2)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-focus)]">
